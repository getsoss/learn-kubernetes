...
export default function Track3Step4Page() {
  const steps = [
    ...
    <div className="flex flex-col h-screen bg-gray-50 overflow-hidden">
      ...
      <main className="flex-1 overflow-auto px-6 py-6">
        <div className="max-w-4xl mx-auto">
          <TrackStepper trackId="track-3" steps={steps} currentStep={4} />
          <h1 className="text-2xl font-bold text-gray-900 mb-2">
            문제해결 패턴
          </h1>
          <div className="bg-white rounded-xl border border-gray-200 p-4 mb-4 font-mono text-sm space-y-1">
            <div>$ kubectl get endpoints myapp</div>
            <div>$ kubectl describe svc myapp</div>
            <div>$ kubectl get ingress -A</div>
          </div>
